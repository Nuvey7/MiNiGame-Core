# MiNiGame Core
이 마인크래프트 플러그인은 1.21.8(JAVA25) 기반으로 제작 되었습니다. (서버 관리진분들은 디스코드 @nuvey7으로 디엠 주세요!)
...
명령어 선언은 [plugin.yml](/home/vireinne/바탕화면/Coding/MINIGAME/src/main/resources/plugin.yml), 

실제 처리 코드는 [command 디렉터리](/home/vireinne/바탕화면/Coding/MINIGAME/src/main/java/dev/minigame/core/command)에 있습니다.

새로운 버전을 더욱 빠르게 다운로드 받으시고 싶으면 https://www.dexxert.kr/plugins/download 로 와주시길 바랍니다.
